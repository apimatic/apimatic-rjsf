...
function computeDefaults(schema, parentDefaults) {
  ...
  if (isObject(defaults) && isObject(schema.default)) {
    ...
    if (schema.oneOf[schemaIndex].hasOwnProperty("oneOf" || "anyOf")) {
      defaults = {
        $$__case: schemaIndex,
        value: computeDefaults(schema.oneOf[schemaIndex], undefined, definitions, schemaIndex)
      };
    } else {
    ...
    case "object":
      {
        ...
        defaults = Object.keys(schema.properties || {}).reduce(function (acc, key) {
          ...
          if (isObject(schema.properties[key]) && schema.properties[key].hasOwnProperty("oneOf" || "anyOf")) {
            var _defaultKey = (defaults || {})[key];
            acc = _extends({}, acc, _defineProperty({}, key, {
              $$__case: schemaIndex,
              value: computeDefaults(schema.properties[key], (_defaultKey || {})[key], definitions)
            }));
          } else {
