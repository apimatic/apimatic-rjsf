    ...
    case "object":
      {
        ...
        defaults = Object.keys(schema.properties || {}).reduce(function (acc, key) {
          ...
          if (isObject(schema.properties[key]) && schema.properties[key].hasOwnProperty("oneOf" || "anyOf")) {
            ...
            acc = _extends({}, acc, (_extends2 = {}, _defineProperty(_extends2, "$$_" + key + "_discriminator", 0), _defineProperty(_extends2, key, computeDefaults(schema.properties[key], (_defaultKey || {})[key], definitions)), _extends2));
          } else {
