...
exports.flattenedFormData = flattenedFormData;
...
function flattenedFormData(formData) {
  ...
  if (isObject(newFormData)) {
    if (checkDiscriminator(newFormData)) {
      ...
      for (var key in newFormData) {
        newFormData = _extends({}, newFormData, _defineProperty({}, key, flattenedFormData(newFormData[key])));
      }
    }
  }
...
function withExactlyOneSubschema(schema, definitions, formData, dependencyKey, oneOf) {
  ...
  var validSubschemas = oneOf.filter(function (subschema) {
    ...
    if (conditionPropertySchema) {
      ...
      var _validateFormData = (0, _validate2.default)(formData, conditionSchema, undefined, undefined, undefined, true),
