    ...
    case "object":
      return Object.keys(schema.properties || {}).reduce(function (acc, key) {
        ...
        if (isObject(schema.properties[key]) && schema.properties[key].hasOwnProperty("oneOf" || "anyOf")) {
          ...
          var _defaultKey = _extends({}, (defaults || {})[key]);
          acc = _extends({}, acc, (_extends2 = {}, _defineProperty(_extends2, "$$_" + key + "_discriminator", 0), _defineProperty(_extends2, key, _extends({}, computeDefaults(schema.properties[key], _defaultKey, definitions))), _extends2));
        } else {
