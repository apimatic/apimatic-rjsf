...
function computeDefaults(schema, parentDefaults) {
  ...
  if (isObject(defaults) && isObject(schema.default)) {
    ...
    var nextRef = refSchema.type === "object" ? schema.$ref : undefined;

    return computeDefaults(refSchema, defaults, undefined, dxInterface, nextRef);
    ...
    case "object":
      {
        defaults = Object.keys(schema.properties || {}).reduce(function (acc, key) {
          acc[key] = computeDefaults(schema.properties[key], (defaults || {})[key], undefined, dxInterface, parentRef);
          return acc;
        }, {});
        break;
      }
...
function findSchemaDefinition(ref) {
  ...
  var $ref = decodeURIComponent(ref);
...
function getDescription(type) {
  var _type$Description = type.Description,
      Description = _type$Description === undefined ? "" : _type$Description;

  var description = typeof Description === "string" ? Description.trim() : "";
  var isDescription = Boolean(description !== "-" && !description.includes("| Type | Value |"));
    ...
    structure.Fields.forEach(function (field) {
      ...
      if (property) {
        ...
        if (property.type === "array") {
          schema.properties[field.GenericName].items = _extends({}, property.items, {
        ...
        schema.properties[field.GenericName] = _extends({}, property, additionalProperties);
      }
    });
  }
