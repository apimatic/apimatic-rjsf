...
exports.classPrefix = exports.guessType = exports.ADDITIONAL_PROPERTY_FLAG = undefined;
...
function stubExistingAdditionalProperties(schema) {
  ...
  Object.keys(formData).forEach(function (key) {
    ...
    var additionalProperties = void 0;
...
function retrieveSchema(schema) {
  ...
  if ("allOf" in schema) {
    try {
      resolvedSchema = (0, _jsonSchemaMergeAllof2.default)(_extends({}, resolvedSchema, {
...
function withDependentSchema(schema, rootSchema, formData, dependencyKey, dependencyValue) {
  ...
  if (oneOf === undefined) {
    ...
    throw new Error("invalid: it is some " + (typeof oneOf === "undefined" ? "undefined" : _typeof(oneOf)) + " instead of an array");
  }
...
function mergeSchemas(obj1, obj2) {
  ...
  return Object.keys(obj2).reduce(function (acc, key) {
    ...
    if (obj1 && obj1.hasOwnProperty(key) && isObject(right)) {
      ...
      // "required" fields.
      acc[key] = (0, _union2.default)(left, right);
    } else {
      acc[key] = right;
    }
    return acc;
