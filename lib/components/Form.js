...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    if (props.uiSchema && props.uiSchema.renderCodeBlock && typeof props.uiSchema.renderCodeBlock === "function") {
      window.renderCodeBlock = function (node) {
        return props.uiSchema.renderCodeBlock({ node: node });
      };
    }
