...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function validate(formData, schema, originalFormData) {
      ...
      return (0, _validate2.default)(formData, schema || this.props.schema, validate, transformErrors, originalFormData, definitions);
    }
  }, {
    key: "renderErrors",
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          renderTypesPopover = _props3.renderTypesPopover,
...
Form.defaultProps = {
  ...
  renderTypesPopover: function renderTypesPopover(source) {
    return source;
  }
};
