...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.onChange = function (formData) {
      ...
      var newFormData = (0, _utils.flattenedFormData)(formData);
      if (mustValidate) {
    ...
    _this.onSubmit = function (event) {
      ...
      if (!_this.props.noValidate) {
        var newFormData = (0, _utils.flattenedFormData)(_this.state.formData);
    ...
    _this.setValidateOneOf = function (validateOneOf) {
  ...
  _createClass(Form, [{
    ...
    value: function getStateFromProps(props) {
      ...
      var formData = props.dontAssignDefaults ? props.formData : (0, _utils.getDefaultFormState)(schema, props.formData, definitions);
      var newFormData = (0, _utils.flattenedFormData)(formData);
    ...
    value: function validate(formData, schema, originalFormData) {
      ...
      var _ref2 = this.state || {},
          validateOneOf = _ref2.validateOneOf;

      return (0, _validate2.default)(formData, schema || this.props.schema, validate, transformErrors, originalFormData, validateOneOf, this.setValidateOneOf);
    }
  }, {
    key: "renderErrors",
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          disableFormJsonEdit = _props3.disableFormJsonEdit,
          markdownRenderer = _props3.markdownRenderer,
          onRouteChange = _props3.onRouteChange;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.renderErrors(),
          uiSchema.expandAllLevel && _react2.default.createElement(
            "div",
            { className: (0, _utils.prefixClass)("expand-all") },
            _react2.default.createElement(
              "button",
              { onClick: this.toggleExpandAll, type: "button" },
          ...
          children ? children : _react2.default.createElement(
            ...
            _react2.default.createElement(
              "button",
              { type: "submit", className: (0, _utils.prefixClass)("btn btn-info") },
              "Submit"
            )
          )
        )
...
Form.defaultProps = {
  ...
  markdownRenderer: function markdownRenderer(source) {
    return source;
  }
};
...
if (process.env.NODE_ENV !== "production") {
  Form.propTypes = {
    ...
    dontAssignDefaults: _propTypes2.default.bool,
    disableFormJsonEdit: _propTypes2.default.bool,
    markdownRenderer: _propTypes2.default.func,
