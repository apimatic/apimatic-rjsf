...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function validate(formData, schema, originalFormData) {
      ...
      return (0, _validate2.default)(formData, schema || this.props.schema, validate, transformErrors, originalFormData);
    }
  }, {
    key: "renderErrors",
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { value: { markdownRenderer: markdownRenderer, onRouteChange: onRouteChange } },
