...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.toggleExpandAll = function () {
      ...
      _this.setState({ expandAll: value });
    };
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var toggleExpandAll = this.toggleExpandAll;
      var _SchemaField = registry.fields.SchemaField;

      return _react2.default.createElement(
        _context.ContextProvider,
        {
          value: { markdownRenderer: markdownRenderer, onRouteChange: onRouteChange, toggleExpandAll: toggleExpandAll }
        },
            ...
            _react2.default.createElement(
              "button",
              {
                onClick: function onClick() {
                  return _this2.toggleExpandAll(!expandAll);
                },
                type: "button"
              },
