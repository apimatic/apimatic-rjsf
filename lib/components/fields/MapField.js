...
function DefaultMapItem(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "div",
      {
        className: props.hasToolbar && props.hasRemove ? "col-xs-8" : "col-xs-9"
      },
      props.children
    ),
    props.hasToolbar && props.hasRemove && _react2.default.createElement(
      "div",
      { className: "col-xs-1 map-item-toolbox" },
...
function AddButton(_ref3) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      { className: "col-xs-3 col-xs-offset-9 map-item-add text-right" },
      _react2.default.createElement(IconBtn, {
        type: "info",
        icon: "plus",
