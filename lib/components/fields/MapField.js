  ...
  return _react2.default.createElement(
    ...
    !props.collapse && _react2.default.createElement(
      "div",
      {
        ...
        }, _defineProperty(_classNames, "depth_" + depth, true), _defineProperty(_classNames, "even-bg", (0, _utils.getEvenOdd)(depth)), _defineProperty(_classNames, "odd-bg", !(0, _utils.getEvenOdd)(depth)), _classNames)))
      },
      _react2.default.createElement(
        "div",
  ...
  _createClass(MapField, [{
    ...
    value: function render() {
      ...
      var mapProps = {
        ...
        className: "field field-array field-array-of-" + addPropsSchema.type + "  " + (0, _utils.getEvenOddClass)(depth) + " depth_" + depth,
