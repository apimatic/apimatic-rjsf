...
var MapField = function (_Component) {
  ...
  _createClass(MapField, [{
    ...
    value: function toggleCollapse(key) {
      this.setState(function (prevState) {
        return _extends({}, prevState, {
          collapseInfo: _extends({}, prevState.collapseInfo, _defineProperty({}, key, !prevState.collapseInfo[key]))
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var addPropsSchema = _extends({}, this.props.schema, (0, _utils.retrieveSchema)(schema.additionalProperties, definitions));
      ...
      var mapProps = {
        ...
        items: this.state.hash.map(function (pair, index) {
          ...
          var collapse = _this5.state.collapseInfo[pair.k] ? true : false;
