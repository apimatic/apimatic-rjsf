...
function MapFieldDescription(_ref2) {
  var DescriptionField = _ref2.DescriptionField,
      ...
      markdownRenderer = _ref2.markdownRenderer,
      renderTypesPopover = _ref2.renderTypesPopover,
  ...
  return _react2.default.createElement(DescriptionField, {
    id: id,
...
function IconBtn(props) {
  ...
  return _react2.default.createElement(
    ...
    _extends({
      type: "button",
      className: (0, _utils.prefixClass)("btn btn-" + type) + " " + className + " " + (0, _utils.prefixClass)("")
    }, otherProps),
    props.children
  );
}
...
function DefaultMapItem(props) {
  ...
  return _react2.default.createElement(
    ...
    !props.collapse && _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("map-field-value-container") },
      _react2.default.createElement(
        "div",
        { className: (0, _utils.prefixClass)("flex"), style: { display: "flex" } },
        _react2.default.createElement(
          "div",
          {
            className: (0, _utils.prefixClass)("flex-1 " + (props.hasToolbar && props.hasRemove ? "" : "")),
            style: { flex: "1" }
          },
          _react2.default.cloneElement(props.children, { fromMap: true })
        )
      )
    )
  );
...
function DefaultNormalMapFieldTemplate(props) {
  ...
  return _react2.default.createElement(
    ...
    !props.collapse && _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("map-item-list-container") },
      _react2.default.createElement(
        "div",
        {
...
var MapField = function (_Component) {
  ...
  function MapField(props) {
    ...
    _this.toggleGroupCollapse = _this.toggleGroupCollapse.bind(_this);
    return _this;
  }
  ...
  _createClass(MapField, [{
    ...
    value: function toggleCollapse(key) {
      this.setState(function (prevState) {
        return _extends({}, prevState, {
          expandInfo: _extends({}, prevState.expandInfo, _defineProperty({}, key, !prevState.expandInfo[key]))
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          depth = _props2.depth,
          isEven = _props2.isEven,
          fromDiscriminator = _props2.fromDiscriminator,
          typeCombinatorTypes = _props2.typeCombinatorTypes,
          markdownRenderer = _props2.markdownRenderer,
          renderTypesPopover = _props2.renderTypesPopover,
          onRouteChange = _props2.onRouteChange;
      ...
      var mapProps = {
        ...
        className: "field field-array field-array-of-" + addPropsSchema.type + "  " + (isEven ? "even" : "odd") + " depth_" + depth,
    ...
    value: function renderMapFieldItem(props) {
      ...
      var schema = itemSchema.title ? itemSchema : _extends({}, itemSchema, {
        title: key
      });
