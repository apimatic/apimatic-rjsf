...
function DefaultMapItem(props) {
  ...
  return _react2.default.createElement(
    "div",
    { key: props.index, className: (0, _utils.prefixClass)("row " + props.className) },
    ...
    _react2.default.createElement(
      "div",
      {
        className: (0, _utils.prefixClass)("col-xs-12"),
        style: {
          display: "flex",
          alignItems: "center",
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          {
            className: (0, _utils.prefixClass)("flex-1 " + (props.hasToolbar && props.hasRemove ? "col-xs-8" : "col-xs-9")),
            style: { flex: "1" }
          },
          props.children
        )
