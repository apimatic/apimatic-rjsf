    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        IconBtn,
        {
          ...
          className: (0, _utils.prefixClass)("btn toggle-button " + (props.header ? "anyof" : ""))
        },
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        props.header || _react2.default.createElement(MapFieldTitle, {
  ...
  function MapField(props) {
    ...
    _this.onKeyAdd = function () {
      ...
      if (itemSchema && itemSchema.hasOwnProperty("oneOf" || "anyOf")) {
        newHash.push({
          k: "key" + index,
          v: (0, _utils.getDefaultFormState)(itemSchema, {
            $$__case: 0,
            value: undefined
          }, definitions)
        });
      ...
      return function (value, options, schemaIndex) {
        ...
        if (itemSchema && itemSchema.hasOwnProperty("oneOf" || "anyOf")) {
          if (schemaIndex !== undefined) {
            ...
            newHash[i] = {
              k: _this2.state.hash[i].k,
              v: _extends({}, _this2.state.hash[i].v, {
                value: value
              })
            };
          }
