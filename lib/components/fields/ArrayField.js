...
function DefaultFixedArrayFieldTemplate(props) {
  return _react2.default.createElement(
    ...
    props.header || _react2.default.createElement(ArrayFieldTitle, {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        title && props.itemsSchema && props.itemsSchema.required && _react2.default.createElement(
          "div",
      ...
      _react2.default.createElement(
        IconBtn,
        {
          tabIndex: "-1",
          onClick: props.toggleCollapse,
          className: (0, _utils.prefixClass)("btn toggle-button anyof")
        },
  ...
  function ArrayField(props) {
    ...
    _this.onAddClick = function (event) {
      ...
      if (itemSchema && itemSchema.hasOwnProperty("oneOf" || "anyOf")) {
        _this.props.onChange([].concat(_toConsumableArray(formData), [(0, _utils.getDefaultFormState)(itemSchema, {
          $$__case: 0,
          value: undefined
    ...
    _this.onChangeForIndex = function (index) {
      return function (value, options, schemaIndex) {
        ...
        var newFormData = formData.map(function (item, i) {
          ...
          if (schema && schema.items && schema.items.hasOwnProperty("oneOf" || "anyOf")) {
            return index === i ? _extends({}, item, {
              $$__case: schemaIndex !== undefined ? schemaIndex : item.$$__case,
              value: jsonValue
            }) : item;
          } else {
      ...
      var arrayProps = {
        ...
        items: items.map(function (item, index) {
          ...
          return _this3.renderArrayFieldItem({
            ...
            itemSchema: _extends({}, itemSchema, { title: "[" + index + "]" }),
            itemData: item,
