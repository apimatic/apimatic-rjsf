  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      props.items && props.items.map(function (item, index) {
        return _react2.default.createElement(DefaultArrayItem, _extends({ key: "outer-array-item-" + index }, item));
      })
    ),
  ...
  return _react2.default.createElement(
    ...
    !props.collapse && _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        props.items && props.items.map(function (item, index) {
          return _react2.default.createElement(DefaultArrayItem, _extends({ key: "inner-array-item-" + index }, item));
        })
      ),
      props.canAdd && _react2.default.createElement(AddButton, {
        onClick: props.onAddClick,
