...
var ArrayField = function (_Component) {
    ...
    _this.onNullifyChange = function () {
      if (_this.shouldDisable()) {
        if (_this.state.originalFormData) {
          ...
          _this.props.onChange((0, _utils.getDefaultFormState)(_this.props.schema, undefined, undefined, _this.props.registry.dxInterface));
        }
      } else {
  ...
  _createClass(ArrayField, [{
    ...
    value: function renderMultiSelect() {
      ...
      var itemsSchema = (0, _utils.retrieveSchema)(schema.items, formData, { definitions: definitions, structures: structures });
