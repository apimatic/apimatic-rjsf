    ...
    props.hasToolbar && _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        props.hasRemove && _react2.default.createElement(
          ...
          _react2.default.createElement(_Icons.DeleteIcon, null)
        )
      )
    )
  );
...
function DefaultNormalArrayFieldTemplate(props) {
  var title = props.schema.title || props.itemsSchema.title;

  var dataType = props.schema.dataTypeDisplayText ? props.schema.dataTypeDisplayText : title;
  ...
  return _react2.default.createElement(
    ...
    dataType && _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("array-type") },
  ...
  _createClass(ArrayField, [{
    ...
    value: function renderNormalArray() {
      ...
      var arrayProps = {
        ...
        className: "field field-array field-array-of-" + itemsSchema.type + " " + (this.props.isEven ? "even" : "odd") + " depth_" + this.props.depth,
