...
function DefaultArrayItem(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)(props.hasToolbar ? "col-xs-9" : "col-xs-12") },
      props.children
    ),
    props.hasToolbar && _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("col-xs-3 array-item-toolbox") },
      _react2.default.createElement(
        "div",
        {
...
function DefaultNormalArrayFieldTemplate(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("element"), id: props.idSchema.$id + "__element" },
      _react2.default.createElement(
        "div",
        { className: (0, _utils.prefixClass)("element-left") },
        _react2.default.createElement(
          "div",
          { className: (0, _utils.prefixClass)("element-header") },
          _react2.default.createElement(ArrayFieldTitle, {
            key: "array-field-title-" + props.idSchema.$id,
            TitleField: props.TitleField,
            idSchema: props.idSchema,
          ...
          _react2.default.createElement(
            "div",
            { className: (0, _utils.prefixClass)("element-toggle-button-wrapper") },
            _react2.default.createElement(
              IconBtn,
              {
                tabIndex: "-1",
              ...
              props.collapse ? _react2.default.createElement(_Icons.CheveronIcon, { width: 14, rotate: 180 }) : _react2.default.createElement(_Icons.CheveronIcon, { width: 14 })
            )
          )
        )
      ),
      _react2.default.createElement(
        "div",
        { className: (0, _utils.prefixClass)("element-content element-right") },
        _react2.default.createElement(
          "div",
          { className: (0, _utils.prefixClass)("element-description") },
    ...
    _react2.default.createElement(
      ...
      !props.collapse && props.items && props.items.map(function (p) {
        return DefaultArrayItem(p);
      })
    ),
    !props.collapse && props.canAdd && _react2.default.createElement(AddButton, {
      onClick: props.onAddClick,
      disabled: props.disabled || props.readonly
    })
  );
...
var ArrayField = function (_Component) {
  ...
  function ArrayField(props) {
    ...
    _this.shouldDisable = function () {
      return (_this.props.formData === undefined || _this.props.formData && _this.props.formData.length === 0) && !_this.props.required;
    };
    ...
    _this.onNullifyChange = function () {
      if (_this.shouldDisable()) {
        if (_this.state.originalFormData) {
          ...
          _this.props.onChange((0, _utils.getDefaultFormState)(_this.props.schema, undefined, _this.props.registry.definitions));
        }
      } else {
  ...
  _createClass(ArrayField, [{
    ...
    value: function renderNormalArray() {
      ...
      var title = schema.title === undefined && itemsSchema.title === undefined ? name : name === undefined ? schema.title || itemsSchema.title : name + " (" + (schema.title || itemsSchema.title) + ")";
      var arrayProps = {
        ...
        items: formData.map(function (item, index) {
          ...
          return _this2.renderArrayFieldItem({
            ...
            itemSchema: _extends({}, itemSchema, {
        ...
        className: "field field-array field-array-of-" + itemsSchema.type + " " + (this.props.isEvent ? "even" : "odd"),
    ...
    value: function renderArrayFieldItem(props) {
      ...
      return {
        children: _react2.default.createElement(SchemaField, {
          schema: _extends({}, itemSchema, { indexAsTitle: "[" + index + "]" }),
          index: index,
...
function AddButton(_ref3) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "p",
      { className: (0, _utils.prefixClass)("col-xs-3 col-xs-offset-9 array-item-add text-right") },
      _react2.default.createElement(
        IconBtn,
        {
          type: "info",
        ...
        _react2.default.createElement(_Icons.PlusIcon, { width: 14 })
      )
    )
  );
}
