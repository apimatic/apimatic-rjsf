...
var DiscriminatorField = function (_React$Component) {
  ...
  function DiscriminatorField(props) {
    ...
    _this.renderSchema = function (depth) {
      ...
      var isDiscriminatorChild = !(childIsArray || childIsMap || childIsNestedMultipleSchema) && schemaDefination;
  ...
  _createClass(DiscriminatorField, [{
    ...
    value: function render() {
      ...
      var fieldSetClassNames = (0, _utils.classNames)((_classNames2 = {
        field: true
      }, _defineProperty(_classNames2, (0, _utils.getEvenOddClass)(depth), true), _defineProperty(_classNames2, "depth_" + depth, true), _defineProperty(_classNames2, "discriminator-field", true), _defineProperty(_classNames2, "even-bg", (0, _utils.getEvenOdd)(depth)), _defineProperty(_classNames2, "odd-bg", !(0, _utils.getEvenOdd)(depth)), _classNames2));
