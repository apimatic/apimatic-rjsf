...
var DiscriminatorField = function (_React$Component) {
  ...
  function DiscriminatorField(props) {
    ...
    _this.toggleCheckbox = function () {
      var _this$props4 = _this.props,
          ...
          definitions = _this$props4.definitions,
      ...
      _this.setState(function (st) {
        ...
        var defaultFormState = (0, _utils.getDefaultFormState)(initialSchema[initialSchemaIndex], getInitialFormData(initialSchema[initialSchemaIndex], initialSchemaIndex, _this.state.caseOf), definitions, 0);
    ...
    _this.componentDidMount = function () {
      var _this$props5 = _this.props,
          ...
          definitions = _this$props5.definitions,
          parentPath = _this$props5.parentPath;
      var _this$state2 = _this.state,
          formState = _this$state2.formState,
          selectedSchema = _this$state2.selectedSchema;


      var defaultFormState = (0, _utils.getDefaultFormState)(selectedSchema.schema, getInitialFormData(selectedSchema.schema, selectedSchema.index, _this.state.caseOf), definitions, 0);
      var path = (0, _validationUtils.getOneAnyOfPath)(parentPath, defaultFormState);
  ...
  _createClass(DiscriminatorField, [{
    ...
    value: function render() {
      ...
      var _multipleSchema$reduc = multipleSchema.reduce(function (_ref, schema, index) {
        ...
        return { selectOptions: selectOptions, charCounts: charCounts + label.length };
          ...
          selectOptions = _multipleSchema$reduc.selectOptions,
          charCounts = _multipleSchema$reduc.charCounts;
      ...
      return _react2.default.createElement(
        ...
        !optional || optional && checked ? _react2.default.createElement(
          "fieldset",
          {
