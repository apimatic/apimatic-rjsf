...
var DiscriminatorField = function (_React$Component) {
  ...
  _createClass(DiscriminatorField, [{
    ...
    value: function render() {
      ...
      var isOddDepth = depth % 2 === 1;

      var hasArrayCheck = isOddDepth && fromArray;

      var parentDepth = fromMap || hasArrayCheck ? this.props.depth + 1 : this.props.depth;

      var childDepth = hasArrayCheck ? parentDepth + 1 : parentDepth;
      ...
      return _react2.default.createElement(
        ...
        !optional || optional && checked && !disabled ? _react2.default.createElement(
          "fieldset",
          {
            className: (0, _utils.prefixClass)("field " + getEvenOddClass(parentDepth) + " depth_" + parentDepth + " discriminator-field")
          },
