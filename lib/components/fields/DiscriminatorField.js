...
var DiscriminatorField = function (_React$Component) {
  ...
  function DiscriminatorField(props) {
    ...
    _this$props$formData = _this$props$formData === undefined ? {} : _this$props$formData;
    var $$__case = _this$props$formData.$$__case;

    var initialSchema = props.schema.oneOf || props.schema.anyOf;
    _this.state = {
      selectedSchema: {
        index: $$__case,
