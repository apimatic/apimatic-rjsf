...
var DiscriminatorField = function (_React$Component) {
  ...
  function DiscriminatorField(props) {
    ...
    _this.renderSchema = function (depth) {
      ...
      return description ? _react2.default.createElement(
        "fieldset",
        { className: (0, _utils.prefixClass)("field  " + discriminatorClassName + " --2") },
  ...
  _createClass(DiscriminatorField, [{
    ...
    value: function render() {
      ...
      var isEvenDepth = depth % 2 === 1 && fromArray;

      var patentDepth = fromMap || isEvenDepth ? this.props.depth + 1 : this.props.depth;

      var childDepth = isEvenDepth ? patentDepth + 1 : patentDepth;
      ...
      console.log("DefaultTemplate", this.props);
      ...
      return _react2.default.createElement(
        ...
        !optional || optional && checked && !disabled ? _react2.default.createElement(
          "fieldset",
          {
            className: (0, _utils.prefixClass)("field " + getEvenOddClass(patentDepth) + " depth_" + patentDepth + " discriminator-field  --1")
          },
