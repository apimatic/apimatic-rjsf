  ...
  function DiscriminatorField(props) {
    ...
    _this.renderSchema = function (depth) {
      ...
      if (typeCombinatorTypes) {
        disciminatorObj = { name: schema.discriminator, value: typeCombinatorTypes[selectedSchema.index].DiscriminatorValue };
    ...
    _this.getSelectOptions = function () {
      var _this$props6 = _this.props,
          ...
          typeCombinatorTypes = _this$props6.typeCombinatorTypes,
          definitions = _this$props6.definitions,
      ...
      return multipleSchema.reduce(function (_ref, schema, index) {
        ...
        if (schema.hasOwnProperty("$ref")) {
          schema = (0, _utils.retrieveSchema)(schema, definitions, formData);
        }
