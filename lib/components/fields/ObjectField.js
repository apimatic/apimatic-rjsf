...
function renderViewJsonButton(props) {
  ...
  return disableViewJsonButton ? _react2.default.createElement(
    ...
    IconBtn,
    {
      ...
      className: (0, _utils.prefixClass)("btn json-button " + (!collapse ? "form-view" : ""))
    },
    _react2.default.createElement(_Icons.JsonIcon, null)
  );
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        (props.uiSchema["ui:title"] || props.title || props.schema.title) && _react2.default.createElement(TitleField, {
      ...
      canCollapse && _react2.default.createElement(
        ...
        }), _defineProperty(_React$createElement, "className", (0, _utils.prefixClass)("btn toggle-button")), _React$createElement),
  ...
  _createClass(ObjectField, [{
    ...
    value: function render() {
      ...
      if (schema.properties && Object.keys(schema.properties).length > 0) {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (_ref) {
            var toggleExpandAll = _ref.toggleExpandAll;
            return _this2.renderObject(_extends({}, templateProps, { toggleExpandAll: toggleExpandAll }));
          }
        );
    ...
    value: function renderObject(templateProps) {
      ...
      var name = templateProps.name,
          ...
          toggleExpandAll = templateProps.toggleExpandAll;
        ...
        properties: orderedProperties.map(function (name) {
          return {
            content: _react2.default.createElement(SchemaField, {
              key: name,
              name: name,
              isEven: !_this3.state.isEven,
              depth: _this3.state.depth + 1,
              expandAll: _this3.state.expandAll,
              expandAllLevel: _this3.state.expandAllLevel,
              ...
              disabled: templateProps.disabled || _this3.shouldDisable(),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onPropertyChange = function (name) {
    return function (value, options) {
      var newFormData = _extends({}, _this4.props.formData, _defineProperty({}, name, value));
      _this4.props.onChange(newFormData, options);
    };
  };
  ...
  this.onNullifyChange = function () {
    ...
    if (_this4.shouldDisable()) {
      if (_this4.state.originalFormData) {
        _this4.props.onChange(_this4.state.originalFormData);
      } else if (!_this4.props.schema.properties) {
        _this4.props.onChange({ key: "value" });
      } else {
        _this4.props.onChange((0, _utils.getDefaultFormState)(_this4.props.schema, _this4.props.formData, _this4.props.definitions));
      }
    } else {
      _this4.props.onChange(undefined);
    }
  };

  this.shouldDisable = function () {
    return (_this4.props.formData === undefined || Object.keys(_this4.props.formData).length === 0) && !_this4.props.required;
  };
