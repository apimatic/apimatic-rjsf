...
function DefaultObjectFieldTemplate(props) {
  var TitleField = props.TitleField,
      ...
      containsNestedObject = props.containsNestedObject,
  ...
  return _react2.default.createElement(
    "div",
    null,
    !uiSchema.disableJsonEdit && _react2.default.createElement(
      "p",
      { style: ViewJsonButtonStyle, onClick: function onClick() {
          return props.toggleEditView();
        } },
      "View JSON"
    ),
    containsNestedObject && _react2.default.createElement(
      "span",
      null,
      "contains nested objects"
    ),
    props.showEditView ? _react2.default.createElement(
      "div",
      null,
