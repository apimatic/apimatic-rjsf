...
function renderViewJsonButton(props) {
  ...
  return _react2.default.createElement(
    "div",
    { style: viewJsonButtonWrapper },
    disableViewJsonButton ? _react2.default.createElement(
      "button",
      {
        className: (0, _utils.prefixClass)("view-json-button"),
...
function DefaultObjectFieldTemplate(props) {
  ...
  return _react2.default.createElement(
    "fieldset",
    { className: (0, _utils.prefixClass)(props.isOdd ? "odd" : "even") },
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          (props.uiSchema["ui:title"] || props.title || props.schema.indexAsTitle) && _react2.default.createElement(
            "div",
            { className: (0, _utils.prefixClass)("element-header-title") },
            _react2.default.createElement(TitleField, {
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: (0, _utils.prefixClass)("element-data-type") },
          props.DataType && _react2.default.createElement(
            "div",
            null,
            props.DataType
          )
    ...
    _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("element-data") },
      ...
      ) : (!collapse || !canCollapse) && props.properties.map(function (prop) {
        return prop.content;
      })
    )
  );
...
var ObjectField = function (_Component) {
  ...
  function ObjectField(props) {
    ...
    _this.state.isOdd = props.isOdd ? true : false;
