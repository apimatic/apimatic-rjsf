...
function renderViewJsonButton(props) {
  var disableViewJsonButton = props.formJsonError || Object.keys(props.errorSchema).length !== 0;

  return disableViewJsonButton ? _react2.default.createElement(
    "button",
    { className: "view-json-button", style: viewJsonButtonStyle, disabled: true },
    "View JSON"
...
function DefaultObjectFieldTemplate(props) {
  ...
  var canEditJson = !props.disableFormJsonEdit && !props.uiSchema.disableFieldJsonEdit;
