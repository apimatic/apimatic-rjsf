...
function renderViewJsonButton(props) {
  ...
  return disableViewJsonButton ? _react2.default.createElement(
    ...
    IconBtn,
    { onClick: toggleEditView, className: (0, _utils.prefixClass)("btn json-button") },
    _react2.default.createElement(_Icons.JsonIcon, null)
  );
  ...
  this.onPropertyChange = function (name) {
    return function (value, options, schemaIndex) {
      ...
      if (schemaIndex !== undefined) {
        newFormData = _extends({}, _this3.props.formData, _defineProperty({}, name, _extends({}, _this3.props.formData[name], {
          $$__case: schemaIndex,
          value: value
        })));
      } else {
        if ((0, _utils.checkDiscriminator)(_this3.props.formData[name])) {
          newFormData = _extends({}, _this3.props.formData, _defineProperty({}, name, _extends({}, _this3.props.formData[name], {
            value: value
          })));
        } else {
