...
var ObjectField = function (_Component) {
  ...
  _createClass(ObjectField, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var collapse = this.state.depth === this.state.expandAllLevel ? !nextProps.expandAll : this.state.collapse;
      this.setState(_extends({}, this.getStateFromProps({ nextProps: nextProps }), {
        collapse: collapse,
