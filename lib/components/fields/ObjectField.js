...
var ObjectField = function (_Component) {
  ...
  _createClass(ObjectField, [{
    ...
    value: function render() {
      ...
      } else if (schema.hasOwnProperty("oneOf") || schema.hasOwnProperty("anyOf") || schema.hasOwnProperty("allOf")) {
    ...
    value: function renderDynamic(templateProps) {
      ...
      return _react2.default.createElement(
        ...
        !templateProps.schema.oneOfType && _react2.default.createElement(
          "div",
