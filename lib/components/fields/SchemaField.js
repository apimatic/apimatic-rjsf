...
function DefaultTemplate(props) {
  ...
  var errors = _react2.default.createElement(ErrorList, { errors: (0, _validationUtils.validateField)(schema, formData, required, disabled) });

  if (schema.readOnly) {
    return null;
  }

  var classes = (0, _utils.classNames)((_classNamesFunc = {}, _defineProperty(_classNamesFunc, (0, _utils.prefixClass)(classNames), true), _defineProperty(_classNamesFunc, "from-discriminator", fromDiscriminator), _classNamesFunc));
...
function SchemaFieldRender(props) {
  ...
  if (schema.allOf && !schema.typeCombinatorTypes) {
    schema = (0, _jsonSchemaMergeAllof2.default)(schema, MERGE_ALLOF_OPTIONS);
  }
  ...
  var classNames = ["form-group", "field", "field-" + type, errors && errors.length > 0 ? "field-error has-error has-danger" : "", schema.oneOf || schema.anyOf ? "discriminator-container" : "", uiSchema.classNames, fromDiscriminator ? "from-discriminator" : ""].join(" ").trim();
...
var SchemaField = function (_React$Component) {
  ...
  _createClass(SchemaField, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      return !(0, _utils.deepEquals)(_extends({}, this.props), _extends({}, nextProps));
    }
  }, {
    key: "render",
