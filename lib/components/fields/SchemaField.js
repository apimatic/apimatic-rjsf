...
function SchemaFieldRender(props) {
  var uiSchema = props.uiSchema,
      ...
      _props$disciminatorOb = props.disciminatorObj,
      disciminatorObj = _props$disciminatorOb === undefined ? {} : _props$disciminatorOb;
  ...
  var discriminatorProperty = disciminatorObj.name;
