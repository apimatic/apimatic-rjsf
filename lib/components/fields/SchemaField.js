...
function DefaultTemplate(props) {
  ...
  return _react2.default.createElement(
    ...
    displayLabel && props.schema.type && _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("base-type") },
      props.schema.data_type_display_text ? props.schema.data_type_display_text : props.schema.type
    ),
    displayLabel && required && _react2.default.createElement(
      "div",
      { className: (0, _utils.prefixClass)("element-required") },
      _react2.default.createElement(_Icons.RequiredInfoIcon, null),
      _react2.default.createElement(
        "span",
        null,
        "Required"
