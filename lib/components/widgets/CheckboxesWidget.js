...
function CheckboxesWidget(props) {
  ...
  return _react2.default.createElement(
    "div",
    { className: (0, _utils.prefixClass)("checkboxes"), id: id },
    enumOptions.map(function (option, index) {
      ...
      return inline ? _react2.default.createElement(
        "label",
        { key: index, className: (0, _utils.prefixClass)("checkbox-inline " + disabledCls) },
        checkbox
      ) : _react2.default.createElement(
        "div",
        { key: index, className: (0, _utils.prefixClass)("checkbox " + disabledCls) },
        _react2.default.createElement(
          "label",
          null,
          checkbox
