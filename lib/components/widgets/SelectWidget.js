...
function getSelectedOptionList(selectedOptions) {
  return selectedOptions.reduce(function (acc, cv) {
...
function SelectWidget(props) {
  ...
  return !multiple ? _react2.default.createElement(
    "select",
    {
      id: id,
      multiple: multiple,
  ...
  ) : _react2.default.createElement(_MultiSelectWidget2.default, {
    defaultValue: value,
    isMulti: true,
    options: enumOptions,
    onChange: function onChange(selectedOption) {
      _onChange(processValue(schema, getSelectedOptionList(selectedOption)));
    } });
}
