...
function SelectWidget(props) {
  ...
  var defaultExample = newOptions.find(function (option) {
    return option.value === schema.example;
  });
  ...
  return _react2.default.createElement(_reactSelect2.default, (_React$createElement = {
    ...
    isMulti: multiple,
    options: newOptions,
    defaultValue: defaultExample || (value ? getDefaultValue(value, multiple, enumOptions, enumDisabled) : emptyValue),
