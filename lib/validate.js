 ...
 */
function validateFormData(formData, schema, customValidate, transformErrors, originalFormData) {
  (0, _validationUtils.validateSchema)(schema, formData, originalFormData, ajv);
