...
function modifyOther(_ref5) {
  ...
  if (fieldValue) {
    var recursiveArray = function recursiveArray(arr) {
      if (Array.isArray(arr)) {
        return arr.map(function (arrItem) {
          return recursiveArray(arrItem);
        });
    ...
    (0, _lodash4.default)(parentSchema, pathFromParentToChild, _extends({}, node, recursiveArray(fieldValue)));
